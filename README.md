...
<li>sudo apt-get install -y zsh tree redis-server nginx gunicorn postgresql-13 zsh openssl libssl-dev postgresql-server-dev-all libpq-dev zlib1g-dev libffi-dev python3.8-dev libsqlite3-dev libxslt-dev
</li>
<br>
